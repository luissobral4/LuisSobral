  ...
  return (
    <div className="w-full dark:bg-green-900 bg-white">
      ...
      <div className="mx-1 sm:mx-8 mt-80 md:mx-16 lg:mx-48">
        <About
          image="/ls.jpg"
          description="Hi! My name is Luís, I am now in my last year in the Computer Science Master Course at University of Minho and computer science is something I have enjoyed studying since the first day I started. I specialize in distributed systems and applications engineering."
